...
namespace BlueSky.Inlays
{
  public partial class SettingsInlay : UserControl, INotifyPropertyChanged
  {
    ...
    {
      var response = await _mainPage.Get<Core.Lexicons.App.BSky.Actor.GetProfiles.Response>(
          new Core.Lexicons.App.BSky.Actor.GetProfiles()
      {

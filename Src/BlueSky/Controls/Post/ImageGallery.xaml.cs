...
namespace BlueSky.Controls.Post
{
  public partial class ImageGallery : UserControl, INotifyPropertyChanged
  {
    ...
    public List<Core.Lexicons.App.BSky.Embed.Images.ViewImage> Images
    {
      get { 
                return GetValue(ImagesProperty) 
                    as List<Core.Lexicons.App.BSky.Embed.Images.ViewImage>; 
          }
      set 
            { 
    ...
    public static readonly DependencyProperty ImagesProperty 
            = DependencyProperty.Register("Images", 
                typeof(List<Core.Lexicons.App.BSky.Embed.Images.ViewImage>), 
                typeof(ImageGallery), new PropertyMetadata(null, ImagesChanged));
    ...
    {
      private List<Core.Lexicons.App.BSky.Embed.Images.ViewImage> _images;
      public ImageGalleryProvider(List<Core.Lexicons.App.BSky.Embed.Images.ViewImage> images)
      {
        _images = images;
      }

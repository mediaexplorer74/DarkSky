...
namespace BlueSky.Controls.Post
{
  public partial class EmbedExternal : UserControl, INotifyPropertyChanged
  {
    ...
    public Core.Lexicons.App.BSky.Embed.External.View External
    {
      get 
            { return GetValue(ExternalProperty) as Core.Lexicons.App.BSky.Embed.External.View; 
            }
      set 
            { SetValue(ExternalProperty, value); 
            }
    }

    public static readonly DependencyProperty ExternalProperty 
            = DependencyProperty.Register("External", 
                typeof(Core.Lexicons.App.BSky.Embed.External.View), 
                typeof(EmbedExternal), 

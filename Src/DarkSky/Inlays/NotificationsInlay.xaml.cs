  ...
  public partial class NotificationsInlay : UserControl, INotifyPropertyChanged
  {
    ...
    public class NotificationGroup
    {
      ...
      public NotificationGroup(NotificationsInlay parent, string type, 
          IEnumerable<ATProto.Lexicons.App.BSky.Notification.Notification> notifications)
      {
        _parent = parent;
        var s = type.Split('|');
        Type = s[0];
      ...
      public IEnumerable<ATProto.Lexicons.App.BSky.Notification.Notification> Notifications 
            { get; 
                set; }

...
namespace Cube.UI.Brushes
{
    public class MicaAltBrush : XamlCompositionBrushBase, INotifyPropertyChanged
    {
        ...
        public static CompositionBrush BuildMicaEffectBrush(Compositor compositor, Color tintColor, float tintOpacity, Color luminosityColor, float luminosityOpacity)
        {
            ...
            //var blurredWallpaperBackdropBrush = 
            //    (ICompositorWithBlurredWallpaperBackdropBrush)((object)compositor); // Code for < 22000 SDK
            micaEffectBrush.SetSourceParameter(
                "BlurredWallpaperBackdrop", 
                default/*blurredWallpaperBackdropBrush.TryCreateBlurredWallpaperBackdropBrush()*/);
            //micaEffectBrush.SetSourceParameter(
            //"BlurredWallpaperBackdrop", compositor.TryCreateBlurredWallpaperBackdropBrush());

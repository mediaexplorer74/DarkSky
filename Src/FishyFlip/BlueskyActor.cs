...
public sealed class BlueskyActor
{
    ...
    public Task<Result<FeedProfile?>> GetProfileAsync(
        ATIdentifier identifier, 
        CancellationToken cancellationToken = default)
    {
        string url = $"{Constants.Urls.Bluesky.Actor.GetActorProfile}?actor={identifier}";
        return this.Client.Get<FeedProfile>(url, 
            this.Options.SourceGenerationContext.FeedProfile, 
    ...
    public Task<Result<FeedProfiles?>> GetProfilesAsync(ATIdentifier[] identifiers, 
        CancellationToken cancellationToken = default)
    {
        ...
        return this.Client.Get<FeedProfiles>(
            url, 
            this.Options.SourceGenerationContext.FeedProfiles, 
            this.Options.JsonSerializerOptions, 
            cancellationToken, 
            this.Options.Logger);
    }

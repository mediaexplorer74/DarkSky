...
public sealed class ATProtocol : IDisposable
{
    ...
    /// </summary>
    public AuthSession? OAuthSession
    {
        get
        {
            return this.sessionManager 
                is OAuth2SessionManager oAuth2SessionManager 
                ? oAuth2SessionManager.OAuthSession : null;
        }
        set
        {
            this.OAuthSession = value;
        } 
    }
    ...
    /// </summary>
    public AuthSession? PasswordSession
    {
        get
        {
            return this.sessionManager 
                is PasswordSessionManager passwordSessionManager ? passwordSessionManager.PasswordSession : null;
        }
    }
    ...
    public AuthSession? AuthSession
    {
        get
        {
            return this.sessionManager switch
            {
